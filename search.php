    ...
    <body>
        <form class="sub-search-container" method="get" autocomplete="off">
            ...
            <div class="sub-search-button-wrapper">
                <button name="t" value="0"><img src="static/images/1.png" alt="text result" />General</button>
                <button name="t" value="1"><img src="static/images/2.png" alt="image result" />Images</button>
                <button name="t" value="2"><img src="static/images/3.png" alt="video result" />Videos</button>
                <button name="t" value="3"><img src="static/images/4.png" alt="torrent result" />Torrents</button>
                <button name="t" value="4"><img src="static/images/5.png" alt="tor result" />Tor</button>
            </div>
        <hr>
        </form>
